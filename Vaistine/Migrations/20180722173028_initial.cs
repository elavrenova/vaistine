    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Cags_Cags_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Cags",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(nullable: false),
                    Descr = table.Column<string>(nullable: true),
                    MainComponentId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Goods_Components_MainComponentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DocLines_GoodId_DocHeadId",
                table: "DocLines",
                columns: new[] { "GoodId", "DocHeadId" },
                unique: true);
